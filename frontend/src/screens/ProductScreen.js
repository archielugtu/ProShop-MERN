...
const ProductScreen = ({ history, match }) => {
  ...
  useEffect(() => {
    // if review was successfully created, then reset the state of the review form
            ...
            <Col className='product-page-section' md={3}>
              <Card>
                <ListGroup variant='flush'>
                  ...
                  {
                    // this says if countInStock > 0 then show blah
              ...
              <ListGroup variant='flush'>
                {product.reviews.map((review) => (
                  <ListGroup.Item key={review._id}>
                    <strong>
                      {review.name}{" "}
                      {userInfo && review.user === userInfo._id ? "(Me)" : ""}
                    </strong>
